...
/***/ function(module, exports, __webpack_require__) {
	...
	var insert = __webpack_require__(300);
	var normalize = __webpack_require__(301);
...
/***/ function(module, exports) {
	...
	var aboutContent = {
	  ...
	  children: [{
	    ...
	    type: 'p',
	    children: ['it was april 30, 2015.', { type: 'br' }, 'himawari watched us from afar. ', 'this is what she saw.', { type: 'br' }, 'clouds. ', 'oceans. ', 'mountains. ', 'me. ', 'and you.']
	  }, '', '', '', {
	    type: 'p',
	    children: ['soon the day would come to an end.', { type: 'br' }, 'and another would begin.']
	  }, '', '', '', {
	    type: 'p',
	    children: ['by ', {
	      type: 'a',
	...
	var type = function () {
	  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(parentNode, content) {
	    var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, l, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, c, childNode;
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 37:
	            ...
	            _context.prev = 41;
	            _iterator2 = content.children[Symbol.iterator]();
	          ...
	          case 43:
	            ...
	            _context.next = 49;
	            return sleep(EL_ITV(c));

	          case 49:
	            _context.next = 51;
	            return type(parentNode, c);
	          ...
	          case 53:
	            childNode = document.createElement(c.type);
	    ...
	    }, _callee, undefined, [[9, 21, 25, 33], [26,, 28, 32], [41, 64, 68, 76], [69,, 71, 75]]);
	  }));
	...
	var setup = exports.setup = function setup() {
	  var containerNode = document.querySelector('#about');
	  var contentNode = document.querySelector('#about-content');

	  document.querySelector('#about-link').addEventListener('click', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
	      ...
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            ...
	            _context2.next = 4;
	            return type(contentNode, aboutContent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _images = __webpack_require__(310);
	...
	window.setup = function () {
	  var canvas = createCanvas(_constants.CANVAS_W + _constants.OFFSET * 2, _constants.CANVAS_W + _constants.OFFSET * 2);
	  canvas.parent('o');
	  colorMode(HSB);
	  background(0, 0, 0);
...
/***/ function(module, exports) {
	...
	var N_LINES = exports.N_LINES = 51;

	// Interval (in ms) of drawing lines and updating image
	var LINE_ITV = exports.LINE_ITV = 0;
	var IMG_ITV = exports.IMG_ITV = 1.8 * 1000;

	// Line length and angle
	var MAX_L = exports.MAX_L = 17;
	var MIN_L = exports.MIN_L = 5;
	var MIN_ANG = exports.MIN_ANG = -70;
	var MAX_ANG = exports.MAX_ANG = -40;
	var MAX_TAN = exports.MAX_TAN = null;

	var IMG_DIR = exports.IMG_DIR = 'images/color/160430';
	var IMG_EXT = exports.IMG_EXT = '.jpg';
	var START = exports.START = new Date('Apr 30 2016 14:50');
	var END = exports.END = new Date('May 1 2016 14:30');
